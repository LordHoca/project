...
# 1. Gunakan model dasar YOLOv8 nano (cepat dan ringan)
...
model.train(
    ...
    batch=8,             # Jumlah gambar per proses (sesuaikan dengan RAM/VRAM)
    patience=20,         # Berapa lama model menunggu sebelum berhenti jika tidak ada peningkatan
